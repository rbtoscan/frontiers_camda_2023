...
This script processes the results of isolate prediction using the MDFS (Minimum Description Length Feature Selection) method.
It calculates the mean probabilities for predictions, identifies the top predictions, and prints them.

Usage: source('mdfs_results_processing.R')
"""
...
# Define the function to process the MDFS results
mdfs_wojtek <- function(file) {
...
mdfs_wojtek('data_directory_path/data/training.csv')